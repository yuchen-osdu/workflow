...
import static org.opengroup.osdu.workflow.provider.gcp.config.GcAirflowConfigConstants.IAP;
...
public class ComposerClientConfiguration {

  private final ComposerProperties composerProperties;

  @Bean
  public ComposerClient composerClient(AirflowConfig airflowConfig)
      throws IOException {
