...
import org.opengroup.osdu.workflow.provider.gcp.service.GcpComposerAirflowApiClient;
...
public class GcpComposerAirflowApiClientServiceProvider implements IAirflowApiClientServiceProvider {
  ...
  public IAirflowApiClient create(AirflowConfig airflowConfig) {
    return new GcpComposerAirflowApiClient(airflowConfig, iapClient);
  }
}
