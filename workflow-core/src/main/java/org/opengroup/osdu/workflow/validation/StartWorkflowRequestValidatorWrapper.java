...
public class StartWorkflowRequestValidatorWrapper
    implements ConstraintValidator<ValidStartWorkflowRequest, StartWorkflowRequest> {

  final IStartWorkflowRequestValidator startWorkflowRequestValidator;

  @Override
  public boolean isValid(StartWorkflowRequest request, ConstraintValidatorContext context) {
    return startWorkflowRequestValidator.isValid(request, context);
  }
