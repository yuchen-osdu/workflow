...
@Slf4j
public class WorkflowEngineExtensionServiceFactory {

  private final List<IWorkflowEngineExtensionServiceProvider> providers;

  public IWorkflowEngineExtension createWorkflowEngineExtension(
      String airflowVersion, IAirflowApiClient airflowApiClient) {

    log.info("Creating Workflow Engine Extension for Airflow version: {}", airflowVersion);
        ...
        .orElseThrow(
            () -> {
              ...
              return new AppException(
                  ...
                  "Unsupported Airflow version(extension): %s".formatted(airflowVersion));
            });
  }
}
