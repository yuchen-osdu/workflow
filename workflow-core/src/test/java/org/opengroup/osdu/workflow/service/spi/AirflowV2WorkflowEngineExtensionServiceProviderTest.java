...
class AirflowV2WorkflowEngineExtensionServiceProviderTest {
  ...
  @InjectMocks
  private AirflowV2WorkflowEngineExtensionServiceProvider provider;
  ...
  @Test
  void should_CreateWorkflowEngineExtension_when_ApiClientIsProvided() {
    // when
    IWorkflowEngineExtension workflowEngineExtension = provider.create(airflowApiClient);

    // then
    assertThat(workflowEngineExtension).isNotNull();
  }
}
