...
class AirflowV1WorkflowEngineServiceProviderTest {

  private static final String V1 = "v1";
  private static final String WRONG_VERSION = "v2";

  @Mock private IAirflowApiClient airflowApiClient;

  @InjectMocks private AirflowV1WorkflowEngineServiceProvider provider;

  @Test
  void should_DoSupport_when_VersionIsV1CaseInsensitive() {
    assertThat(provider.supports(V1)).isTrue();
    assertThat(provider.supports(V1.toLowerCase())).isTrue();
    assertThat(provider.supports(V1.toUpperCase())).isTrue();
  }
