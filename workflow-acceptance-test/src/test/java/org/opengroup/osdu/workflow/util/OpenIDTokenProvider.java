...
import org.opengroup.osdu.workflow.util.conf.OpenIDProviderConfig;
...
public class OpenIDTokenProvider {
	...
	public OpenIDTokenProvider() {
		...
		this.clientAuthentication = new ClientSecretBasic(new ClientID(openIDProviderConfig.getClientId()),
	...
	public String getToken() {
		try {
			TokenRequest request = new TokenRequest(this.tokenEndpointURI, this.clientAuthentication, this.clientGrant,
					this.scope);
	...
	public String getNoAccessToken() {
		try {
			TokenRequest request = new TokenRequest(this.tokenEndpointURI, this.noAccessClientAuthentication,
