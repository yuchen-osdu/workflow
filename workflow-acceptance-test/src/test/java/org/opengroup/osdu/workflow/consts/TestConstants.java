...
public class TestConstants {
	...
	public static final String GET_WORKFLOW_RUN_BY_ID_API_ENDPOINT = CREATE_WORKFLOW_API_ENDPOINT
			+ "/%s/workflowRun/%s";
	...
	public static final List<String> FINISHED_WORKFLOW_RUN_STATUSES = Arrays.asList(WORKFLOW_STATUS_TYPE_FINISHED,
			WORKFLOW_STATUS_TYPE_FAILED, WORKFLOW_STATUS_TYPE_SUCCESS);

	public static final String START_WORKFLOW_URL = getEnvironmentVariableOrDefaultKey(WORKFLOW_HOST)
			+ START_WORKFLOW_API_ENDPOINT;
	public static final String GET_STATUS_URL = getEnvironmentVariableOrDefaultKey(WORKFLOW_HOST)
			+ GET_STATUS_API_ENDPOINT;
	public static final String UPDATE_STATUS_URL = getEnvironmentVariableOrDefaultKey(WORKFLOW_HOST)
			+ UPDATE_STATUS_API_ENDPOINT;
	public static final String CREATE_WORKFLOW_URL = getEnvironmentVariableOrDefaultKey(WORKFLOW_HOST)
			+ CREATE_WORKFLOW_API_ENDPOINT;
	public static final String CREATE_WORKFLOW_RUN_URL = getEnvironmentVariableOrDefaultKey(WORKFLOW_HOST)
			+ CREATE_WORKFLOW_RUN_API_ENDPOINT;
	public static final String CREATE_SYSTEM_WORKFLOW_URL = getEnvironmentVariableOrDefaultKey(WORKFLOW_HOST)
			+ CREATE_SYSTEM_WORKFLOW_API_ENDPOINT;
	public static final String GET_WORKFLOW_URL = getEnvironmentVariableOrDefaultKey(WORKFLOW_HOST)
			+ GET_WORKFLOW_BY_ID_API_ENDPOINT;
	public static final String GET_WORKFLOW_RUN_URL = getEnvironmentVariableOrDefaultKey(WORKFLOW_HOST)
			+ GET_WORKFLOW_RUN_BY_ID_API_ENDPOINT;
	public static final String GET_SYSTEM_WORKFLOW_BY_ID_URL = getEnvironmentVariableOrDefaultKey(WORKFLOW_HOST)
			+ GET_SYSTEM_WORKFLOW_BY_ID_API_ENDPOINT;
	public static final String GET_DETAILS_WORKFLOW_RUN_URL = getEnvironmentVariableOrDefaultKey(WORKFLOW_HOST)
			+ GET_WORKFLOW_RUN_BY_ID_API_ENDPOINT;
	public static final String GET_SERVICE_INFO_URL = getEnvironmentVariableOrDefaultKey(WORKFLOW_HOST)
			+ GET_SERVICE_INFO_API_ENDPOINT;
