...
public interface WorkflowUpdateRunStatusHelper {
	...
	static ClientResponse sendWorkflowRunFinishedUpdateRequest(HTTPClient client, String workflowName, String runId,
	...
	static List<String> getWorkflowRuns(HTTPClient client, String workflowName, Map<String, String> headers)
			throws Exception {
